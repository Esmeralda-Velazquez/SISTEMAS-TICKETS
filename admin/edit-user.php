...
if (isset($_POST['update'])) { 
  ...
  try {
    $ret = mysqli_query($con, "UPDATE user SET name='$name', mobile='$contact', password='$password' WHERE id='$userid'");
    if ($ret) {
            ...
            <div class="row justify-content-center">
              <div class="col-lg-8 col-md-10 col-xs-12 mx-auto">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control rounded-0" id="password" name="password" value="<?php echo $rw['password']; ?>" required="required">
                </div>
                <div class="form-group">
