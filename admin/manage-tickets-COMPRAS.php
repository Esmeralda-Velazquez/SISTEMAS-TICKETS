...
<body class="">
  ...
  <div class="page-content">
    ...
    <div class="clearfix"></div>
    <div class="content">
      <h2 style="color: #2b4c7e; text-align: center;"><strong>COMPRAS</strong></h2>
      <ul class="breadcrumb">
        <li>
          <p>Inicio</p>
        </li>
      ...
      foreach ($statuses as $status) {
        ...
        $rt = mysqli_query($con, "SELECT * FROM ticket WHERE status = '$status' and area_asig = 'COMPRAS' ORDER BY id DESC");
                          ...
                          <div class="row" style="width: 800px;">
                            ...
                            <?php
                              if (($rol === "MANTENIMIENTO" || $rol === "COMPRAS" || $rol === "ERP SILVA") && !empty($row['area_asig'])) {
                                ...
                                $sql2 = "SELECT DISTINCT area FROM admin WHERE area != 'COMPRAS'";
                                $result = $con->query($sql2);
                                while ($row2 = $result->fetch_assoc()) {
                                  $atender = htmlspecialchars($row2["area"]);
                                  echo "<option value=\"$atender\">$atender</option>";
