...
<body class="">
  ...
  <div class="page-content">
    ...
    <div class="clearfix"></div>
    <div class="content">
      <h2 style="color: #2b4c7e; text-align: center;"><strong>ERP SILVA</strong></h2>
      <ul class="breadcrumb">
        <li>
          <p>Inicio</p>
        </li>
      ...
      foreach ($statuses as $status) {
        ...
        $rt = mysqli_query($con, "SELECT * FROM ticket WHERE status = '$status' and area_asig = 'ERP SILVA' ORDER BY id DESC");
                      ...
                      <div class="col-md-6 col-xs-12">
                        ...
                        <form name="adminr" method="post" enctype="multipart/form-data">
                          ...
                          <div class="row" style="width: 800px;">
                            ...
                            ?>
                            <?php
                              if (($rol === "MANTENIMIENTO" || $rol === "COMPRAS" || $rol === "ERP SILVA") && !empty($row['area_asig'])) {
                                ...
                                echo '<option value="ERP SILVA"> ERP SILVA</option>';

                                $sql2 = "SELECT DISTINCT area FROM admin WHERE area != 'ERP SILVA'";
                                $result = $con->query($sql2);
                                while ($row2 = $result->fetch_assoc()) {
                                  $atender = htmlspecialchars($row2["area"]);
                                  echo "<option value=\"$atender\">$atender</option>";
                          ...
                          <?php
                              if (isset($_POST['update'])) {
                                ...
                                // Verifica si la reasignación está presente en el formulario
                                if (isset($_POST['reassignedUpdate']) && !empty($_POST['reassignedUpdate'])) {
                                  $newAssigned = $_POST['reassignedUpdate'];
                                  mysqli_query($con, "UPDATE ticket SET area_asig='$newAssigned' WHERE id='$fid'");
                                }
