...
<body class="">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form name="abc" action="" method="post">
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-xs btn-mini rounded-0 eliminar-usuario" data-userid="<?php echo $row['id']; ?>">Eliminar</button>
    ...
    <script>
        //ELIMINAR USUARIO E TABLA DE GESTION DE USUARIOS 
