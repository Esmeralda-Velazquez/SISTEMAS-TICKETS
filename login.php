...
if (isset($_POST['login'])) {
  ...
  if ($num > 0) {
    ...
    $ret = mysqli_query($con, "insert into usercheck(logindate,logintime,user_id,username)values
    ('" . $val3 . "','" . $tim . "','" . $_SESSION['id'] . "','" . $_SESSION['name'] . "')");
  ...
  <div class="container">
    <div class="row login-container">
      ...
      <div class="col-md-5 "> <br>
        <p style="color:#Fff"><?php echo $_SESSION['action1']; ?><?php echo $_SESSION['action1'] = ""; ?></p>
        <form id="login-form" class="login-form" action="" method="post">
          <p style="color: #F00"><?php echo $_SESSION['action1']; ?><?php echo $_SESSION['action1'] = ""; ?></p>
          <div class="form-group">
            <label for="text" class="control-label">Usuario</label>
            <input type="text" class="form-control rounded-0" id="user" name="user" required="required">
          </div>
          <div class="form-group">
